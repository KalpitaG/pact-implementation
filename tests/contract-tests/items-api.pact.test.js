...
describe('Items API Contract', () => {
    ...
    test('get items filtered by category and inStock', async () => {
        provider
            .given('items exist in the inventory for a specific category and stock status')
            .uponReceiving('a request to get items filtered by category and inStock')
            .withRequest({
                method: 'GET',
                path: '/items',
                query: {
    ...
    test('get a single item by ID', async () => {
        provider
            .given('item 1 exists')
            .uponReceiving('a request to get a single item by ID')
    ...
    test('search for items by query string', async () => {
        provider
            .given('items exist matching the search query')
            .uponReceiving('a request to search for items by query string')
            .withRequest({
                method: 'GET',
                path: '/items/search',
    ...
    test('create a new item', async () => {
        ...
        provider
            .given('the items API is available to create items')
